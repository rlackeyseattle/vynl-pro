...
import '../stage/stage.css'; // Import from stage folder until we move/dup css
...
export default function StagePage() {
    ...
    return (
        <div className={`stage-container ${isPresenterMode ? 'presenter-mode' : ''}`}>
            ...
            <AnimatePresence>
                {/* RTLCC BRANDING HEADER (Only in sidebar open?) */}
            </AnimatePresence>
                ...
                {isSidebarOpen && !isPresenterMode && (
                    <motion.aside initial={{ x: -320 }} animate={{ x: 0 }} exit={{ x: -320 }} className="sidebar">
                        <div className="sidebar-header">
                            <h2 className="gradient-text">RTLCC // STAGE</h2>
                        </div>
