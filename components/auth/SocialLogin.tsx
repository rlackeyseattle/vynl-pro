...
export default function SocialLogin() {
    ...
    const callbackUrl = searchParams.get("callbackUrl") || "/roblackey";
    ...
    return (
        <div className="flex flex-col gap-3 w-full">
            <div className="relative flex items-center py-2">
                ...
                <span className="flex-shrink-0 mx-4 text-xs text-neutral-500 uppercase tracking-widest">Or access via</span>
                <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                <button
                    ...
                    className="flex items-center justify-center gap-2 bg-white text-black px-4 py-3 rounded-lg hover:bg-neutral-200 transition-colors"
                >
                ...
                <button
                    ...
                    className="flex items-center justify-center gap-2 bg-[#5865F2] text-white px-4 py-3 rounded-lg hover:bg-[#4752C4] transition-colors"
                >
