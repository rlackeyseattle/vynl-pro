          ...
          <header className="sticky top-0 z-50 w-full border-b border-zinc-800 bg-zinc-950/80 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/60">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
              ...
              <nav className="flex items-center space-x-6 text-sm font-medium">
                <Link href="/bands" className="hover:text-pink-400 transition-colors">Bands</Link>
                <Link href="/venues" className="hover:text-pink-400 transition-colors">Venues</Link>
                <Link href="/map" className="hover:text-pink-400 transition-colors">Tour Map</Link>
                <AuthButton />
              </nav>
            </div>
          </header>
